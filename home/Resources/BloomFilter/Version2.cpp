...
/*
Modified from initial bloom filter in order to take in strings
*/

//  g++ ./Programming/ClassSelection.cpp ./Programming/BloomFilter.cpp -o prog && ./prog

//  g++ BloomFilter.cpp Class.cpp ClassSelection.cpp student.cpp -o prog && ./prog ClassData.csv StudentData.csv
